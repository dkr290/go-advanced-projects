...
const (
	...
	CalculatorService_GenerateFibunacci_FullMethodName = "/calculator.CalculatorService/GenerateFibunacci"
...
type CalculatorServiceClient interface {
	...
	GenerateFibunacci(ctx context.Context, in *GenerateFibunacciRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[GenerateFibunacciResponse], error)
...
func (c *calculatorServiceClient) GenerateFibunacci(ctx context.Context, in *GenerateFibunacciRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[GenerateFibunacciResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &CalculatorService_ServiceDesc.Streams[0], CalculatorService_GenerateFibunacci_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[GenerateFibunacciRequest, GenerateFibunacciResponse]{ClientStream: stream}
...
type CalculatorService_GenerateFibunacciClient = grpc.ServerStreamingClient[GenerateFibunacciResponse]
...
type CalculatorServiceServer interface {
	...
	GenerateFibunacci(*GenerateFibunacciRequest, grpc.ServerStreamingServer[GenerateFibunacciResponse]) error
...
func (UnimplementedCalculatorServiceServer) GenerateFibunacci(*GenerateFibunacciRequest, grpc.ServerStreamingServer[GenerateFibunacciResponse]) error {
	return status.Error(codes.Unimplemented, "method GenerateFibunacci not implemented")
}
...
func _CalculatorService_GenerateFibunacci_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(GenerateFibunacciRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(CalculatorServiceServer).GenerateFibunacci(m, &grpc.GenericServerStream[GenerateFibunacciRequest, GenerateFibunacciResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type CalculatorService_GenerateFibunacciServer = grpc.ServerStreamingServer[GenerateFibunacciResponse]
...
var CalculatorService_ServiceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		{
			StreamName:    "GenerateFibunacci",
			Handler:       _CalculatorService_GenerateFibunacci_Handler,
			ServerStreams: true,
		},
		{
