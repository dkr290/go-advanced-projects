...
func (UnimplementedBlogServiceServer) ListBlog(*emptypb.Empty, grpc.ServerStreamingServer[Blog]) error {
	return status.Error(codes.Unimplemented, "method ListBlog not implemented")
}
