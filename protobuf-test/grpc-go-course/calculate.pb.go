...
const file_calculate_proto_rawDesc = "" +
	"\n" +
	"\x0fcalculate.proto\x12\tcalculate\x1a\fprimes.proto\".\n" +
	...
	"\tCalculate\x12\x1b.calculate.CalculateRequest\x1a\x1c.calculate.CalculateResponse\x12<\n" +
	"\x05Prime\x12\x17.calculate.PrimeRequest\x1a\x18.calculate.PrimeResponse0\x01BHZFgithub.com/dkr290-go-advanced-projects/grpc-go-course/calculator/protob\x06proto3"

var (
	file_calculate_proto_rawDescOnce sync.Once
	file_calculate_proto_rawDescData []byte
)

func file_calculate_proto_rawDescGZIP() []byte {
	file_calculate_proto_rawDescOnce.Do(func() {
		file_calculate_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_calculate_proto_rawDesc), len(file_calculate_proto_rawDesc)))
	})
...
var file_calculate_proto_goTypes = []any{
	...
	(*PrimeRequest)(nil),      // 2: calculate.PrimeRequest
	(*PrimeResponse)(nil),     // 3: calculate.PrimeResponse
}
var file_calculate_proto_depIdxs = []int32{
	0, // 0: calculate.CalculateService.Calculate:input_type -> calculate.CalculateRequest
	2, // 1: calculate.CalculateService.Prime:input_type -> calculate.PrimeRequest
	1, // 2: calculate.CalculateService.Calculate:output_type -> calculate.CalculateResponse
	3, // 3: calculate.CalculateService.Prime:output_type -> calculate.PrimeResponse
...
func file_calculate_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_calculate_proto_rawDesc), len(file_calculate_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   1,
