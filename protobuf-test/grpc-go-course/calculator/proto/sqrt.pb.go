...
const file_sqrt_proto_rawDesc = "" +
	"\n" +
	"\n" +
	"sqrt.proto\x12\tcalculate\"%\n" +
	"\vSqrtRequest\x12\x16\n" +
	"\x06number\x18\x01 \x01(\x05R\x06number\"&\n" +
	"\fSqrtResponse\x12\x16\n" +
	"\x06result\x18\x01 \x01(\x01R\x06result2F\n" +
	"\vSqrtService\x127\n" +
	"\x04Sqrt\x12\x16.calculate.SqrtRequest\x1a\x17.calculate.SqrtResponseBHZFgithub.com/dkr290-go-advanced-projects/grpc-go-course/calculator/protob\x06proto3"
...
var file_sqrt_proto_goTypes = []any{
	(*SqrtRequest)(nil),  // 0: calculate.SqrtRequest
	(*SqrtResponse)(nil), // 1: calculate.SqrtResponse
}
var file_sqrt_proto_depIdxs = []int32{
	0, // 0: calculate.SqrtService.Sqrt:input_type -> calculate.SqrtRequest
	1, // 1: calculate.SqrtService.Sqrt:output_type -> calculate.SqrtResponse
