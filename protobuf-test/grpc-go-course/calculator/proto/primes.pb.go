...
const file_primes_proto_rawDesc = "" +
	"\n" +
	"\fprimes.proto\x12\tcalculate\"&\n" +
	"\fPrimeRequest\x12\x16\n" +
	"\x06number\x18\x01 \x01(\x03R\x06number\"'\n" +
	"\rPrimeResponse\x12\x16\n" +
	"\x06result\x18\x01 \x01(\x03R\x06resultBHZFgithub.com/dkr290-go-advanced-projects/grpc-go-course/calculator/protob\x06proto3"
...
var file_primes_proto_goTypes = []any{
	(*PrimeRequest)(nil),  // 0: calculate.PrimeRequest
	(*PrimeResponse)(nil), // 1: calculate.PrimeResponse
}
