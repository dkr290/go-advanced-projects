...
const (
	Order_ORDER_ASC_UNSPECIFIED Order = 0
...
func (x *SortField) GetOrder() Order {
	...
	return Order_ORDER_ASC_UNSPECIFIED
}
...
type StudentIds struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Ids           []*Student             `protobuf:"bytes,1,rep,name=ids,proto3" json:"ids,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *StudentIds) GetIds() []*Student {
	if x != nil {
		return x.Ids
	}
	return nil
...
const file_students_proto_rawDesc = "" +
	"\n" +
	"\x0estudents.proto\x12\x04main\"\xa5\x01\n" +
	...
	"\bStudents\x12)\n" +
	"\bstudents\x18\x01 \x03(\v2\r.main.StudentR\bstudents\"U\n" +
	...
	"\n" +
	"StudentIds\x12\x1f\n" +
	"\x03ids\x18\x01 \x03(\v2\r.main.StudentR\x03ids*2\n" +
	"\x05Order\x12\x19\n" +
	"\x15ORDER_ASC_UNSPECIFIED\x10\x00\x12\x0e\n" +
	"\n" +
	"ORDER_DESC\x10\x012\xf1\x01\n" +
	...
	"\x0eDeleteStudents\x12\x10.main.StudentIds\x1a .main.DeleteStudentsConfirmationBIZGgithub.com/dkr290-go-advanced-projects/protobuf-test/grpc-api/proto/genb\x06proto3"
...
var file_students_proto_goTypes = []any{
	...
	(*GetStudentsRequest)(nil),         // 1: main.GetStudentsRequest
	(*SortField)(nil),                  // 2: main.SortField
	(*Student)(nil),                    // 3: main.Student
	(*Students)(nil),                   // 4: main.Students
	(*DeleteStudentsConfirmation)(nil), // 5: main.DeleteStudentsConfirmation
	(*StudentId)(nil),                  // 6: main.StudentId
	(*StudentIds)(nil),                 // 7: main.StudentIds
}
var file_students_proto_depIdxs = []int32{
	3, // 0: main.GetStudentsRequest.student:type_name -> main.Student
	2, // 1: main.GetStudentsRequest.sort_by:type_name -> main.SortField
	0, // 2: main.SortField.order:type_name -> main.Order
	3, // 3: main.Students.students:type_name -> main.Student
	3, // 4: main.StudentIds.ids:type_name -> main.Student
	1, // 5: main.StudentsService.GetStudents:input_type -> main.GetStudentsRequest
	4, // 6: main.StudentsService.AddStudents:input_type -> main.Students
	4, // 7: main.StudentsService.UpdateStudents:input_type -> main.Students
	7, // 8: main.StudentsService.DeleteStudents:input_type -> main.StudentIds
	4, // 9: main.StudentsService.GetStudents:output_type -> main.Students
	4, // 10: main.StudentsService.AddStudents:output_type -> main.Students
	4, // 11: main.StudentsService.UpdateStudents:output_type -> main.Students
	5, // 12: main.StudentsService.DeleteStudents:output_type -> main.DeleteStudentsConfirmation
