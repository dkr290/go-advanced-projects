...
func (x *UpdatePasswordReponse) GetPasswordUpdated() bool {
	if x != nil {
...
func (x *UpdatePasswordReponse) GetToken() string {
	if x != nil {
		return x.Token
	}
	return ""
...
func (x *ExecLogoutReponse) Reset() {
	*x = ExecLogoutReponse{}
...
func (x *ExecLogoutReponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ExecLogoutReponse) ProtoMessage() {}

func (x *ExecLogoutReponse) ProtoReflect() protoreflect.Message {
	mi := &file_execs_proto_msgTypes[9]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ExecLogoutReponse.ProtoReflect.Descriptor instead.
func (*ExecLogoutReponse) Descriptor() ([]byte, []int) {
	return file_execs_proto_rawDescGZIP(), []int{9}
}

func (x *ExecLogoutReponse) GetLoggedOut() bool {
	if x != nil {
		return x.LoggedOut
	}
	return false
...
type Exec struct {
	...
	PasswordChangeAt     string                 `protobuf:"bytes,7,opt,name=password_change_at,json=passwordChangeAt,proto3" json:"password_change_at,omitempty"`
...
func (x *Exec) GetPasswordChangeAt() string {
	if x != nil {
...
type ExecIds struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Ids           []*Exec                `protobuf:"bytes,1,rep,name=ids,proto3" json:"ids,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_execs_proto_rawDesc = "" +
	"\n" +
	"\vexecs.proto\x12\x04main\x1a\x0estudents.proto\"A\n" +
	...
	"\x10confirm_password\x18\x03 \x01(\tR\x0fconfirmPassword\"X\n" +
	"\x15UpdatePasswordReponse\x12)\n" +
	...
	"\x12password_change_at\x18\a \x01(\tR\x10passwordChangeAt\x12&\n" +
	...
	"\aExecIds\x12\x1c\n" +
	"\x03ids\x18\x01 \x03(\v2\n" +
	".main.ExecR\x03ids2\xca\x04\n" +
	"\fExecsService\x12.\n" +
	...
	"\x05Login\x12\x16.main.ExecLoginRequest\x1a\x17.main.ExecLoginResponse\x125\n" +
	"\x06Logout\x12\x12.main.EmptyRequest\x1a\x17.main.ExecLogoutReponse\x12J\n" +
	"\x0eUpdatePassword\x12\x1b.main.UpdatePasswordRequest\x1a\x1b.main.UpdatePasswordReponse\x12?\n" +
	...
	"\x0eDeactivateUser\x12\r.main.ExecIds\x1a\x12.main.ConfirmationBIZGgithub.com/dkr290-go-advanced-projects/protobuf-test/grpc-api/proto/genb\x06proto3"
...
var file_execs_proto_goTypes = []any{
	(*ExecLoginResponse)(nil),       // 0: main.ExecLoginResponse
	(*ExecLoginRequest)(nil),        // 1: main.ExecLoginRequest
	...
	(*UpdatePasswordReponse)(nil),   // 6: main.UpdatePasswordReponse
	(*UpdatePasswordRequest)(nil),   // 7: main.UpdatePasswordRequest
	(*EmptyRequest)(nil),            // 8: main.EmptyRequest
	(*ExecLogoutReponse)(nil),       // 9: main.ExecLogoutReponse
	(*GetExecsRequest)(nil),         // 10: main.GetExecsRequest
	(*Exec)(nil),                    // 11: main.Exec
	(*Execs)(nil),                   // 12: main.Execs
	(*DeleteExecsConfirmation)(nil), // 13: main.DeleteExecsConfirmation
	(*ExecId)(nil),                  // 14: main.ExecId
	(*ExecIds)(nil),                 // 15: main.ExecIds
	(*SortField)(nil),               // 16: main.SortField
}
var file_execs_proto_depIdxs = []int32{
	11, // 0: main.GetExecsRequest.exec:type_name -> main.Exec
	16, // 1: main.GetExecsRequest.sort_by:type_name -> main.SortField
	11, // 2: main.Execs.execs:type_name -> main.Exec
	11, // 3: main.ExecIds.ids:type_name -> main.Exec
	10, // 4: main.ExecsService.GetExecs:input_type -> main.GetExecsRequest
	12, // 5: main.ExecsService.AddExecs:input_type -> main.Execs
	12, // 6: main.ExecsService.UpdateExecs:input_type -> main.Execs
	15, // 7: main.ExecsService.DeleteExecs:input_type -> main.ExecIds
	1,  // 8: main.ExecsService.Login:input_type -> main.ExecLoginRequest
	8,  // 9: main.ExecsService.Logout:input_type -> main.EmptyRequest
	...
	15, // 13: main.ExecsService.DeactivateUser:input_type -> main.ExecIds
	12, // 14: main.ExecsService.GetExecs:output_type -> main.Execs
	12, // 15: main.ExecsService.AddExecs:output_type -> main.Execs
	12, // 16: main.ExecsService.UpdateExecs:output_type -> main.Execs
	13, // 17: main.ExecsService.DeleteExecs:output_type -> main.DeleteExecsConfirmation
	0,  // 18: main.ExecsService.Login:output_type -> main.ExecLoginResponse
	9,  // 19: main.ExecsService.Logout:output_type -> main.ExecLogoutReponse
	6,  // 20: main.ExecsService.UpdatePassword:output_type -> main.UpdatePasswordReponse
