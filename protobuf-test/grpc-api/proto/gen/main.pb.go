...
const file_main_proto_rawDesc = "" +
	"\n" +
	"\n" +
	"main.proto\x12\x04main\x1a\x0estudents.proto\"g\n" +
	...
	"\bTeachers\x12)\n" +
	"\bteachers\x18\x01 \x03(\v2\r.main.TeacherR\bteachers\"U\n" +
	...
	"\n" +
	"TeacherIds\x12!\n" +
	"\x03ids\x18\x01 \x03(\v2\x0f.main.TeacherIdR\x03ids\"K\n" +
	"\fStudentCount\x12\x16\n" +
	"\x06status\x18\x01 \x01(\bR\x06status\x12#\n" +
	"\rstudent_count\x18\x02 \x01(\x05R\fstudentCount2\xf5\x02\n" +
	...
	"\x1dGetStudentCountByClassTeacher\x12\x0f.main.TeacherId\x1a\x12.main.StudentCountBIZGgithub.com/dkr290-go-advanced-projects/protobuf-test/grpc-api/proto/genb\x06proto3"
...
var file_main_proto_goTypes = []any{
	(*GetTeachersRequest)(nil),         // 0: main.GetTeachersRequest
	(*Teacher)(nil),                    // 1: main.Teacher
	(*Teachers)(nil),                   // 2: main.Teachers
	(*DeleteTeachersConfirmation)(nil), // 3: main.DeleteTeachersConfirmation
	(*TeacherId)(nil),                  // 4: main.TeacherId
	(*TeacherIds)(nil),                 // 5: main.TeacherIds
	(*StudentCount)(nil),               // 6: main.StudentCount
	(*SortField)(nil),                  // 7: main.SortField
	(*Students)(nil),                   // 8: main.Students
}
var file_main_proto_depIdxs = []int32{
	1,  // 0: main.GetTeachersRequest.teacher:type_name -> main.Teacher
	7,  // 1: main.GetTeachersRequest.sort_by:type_name -> main.SortField
	1,  // 2: main.Teachers.teachers:type_name -> main.Teacher
	4,  // 3: main.TeacherIds.ids:type_name -> main.TeacherId
	0,  // 4: main.TeachersService.GetTeachers:input_type -> main.GetTeachersRequest
	2,  // 5: main.TeachersService.AddTeachers:input_type -> main.Teachers
	2,  // 6: main.TeachersService.UpdateTeachers:input_type -> main.Teachers
	5,  // 7: main.TeachersService.DeleteTeachers:input_type -> main.TeacherIds
	4,  // 8: main.TeachersService.GetStudentsByClassTeacher:input_type -> main.TeacherId
	4,  // 9: main.TeachersService.GetStudentCountByClassTeacher:input_type -> main.TeacherId
	2,  // 10: main.TeachersService.GetTeachers:output_type -> main.Teachers
	2,  // 11: main.TeachersService.AddTeachers:output_type -> main.Teachers
	2,  // 12: main.TeachersService.UpdateTeachers:output_type -> main.Teachers
	...
	6,  // 15: main.TeachersService.GetStudentCountByClassTeacher:output_type -> main.StudentCount
