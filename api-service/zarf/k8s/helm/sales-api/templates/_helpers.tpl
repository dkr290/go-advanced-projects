...
helm.sh/chart: {{ include "sales-api.chart" . }}
{{ include "sales-api.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
*/}}
{{- define "sales-api.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "sales-api.fullname" .) .Values.serviceAccount.name }}
{{- else }}
